...
/* harmony import */ var _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26);
...
// EXTERNAL MODULE: /home/pomber/p/dev/react/node_modules/lz-string/libs/lz-string.js
var lz_string = __webpack_require__(24);
...
// EXTERNAL MODULE: /home/pomber/p/dev/react/build/oss-experimental/react-debug-tools/index.js
var react_debug_tools = __webpack_require__(25);
...
function attach(hook, rendererID, renderer, global) {
  ...
  function logElementToConsole(id) {
    ...
    console.log('Copy this:', tree);
    const hash = lz_string_default.a.compressToEncodedURIComponent(JSON.stringify(tree));
    console.log('Link:', `http://localhost:3333/#${hash}`);
    window.open(`http://localhost:3333/#${hash}`, '_blank'); // const supportsGroup = typeof console.groupCollapsed === 'function';
    // if (supportsGroup) {
...
// EXTERNAL MODULE: /home/pomber/p/dev/react/node_modules/lodash.throttle/index.js
...
// CONCATENATED MODULE: /home/pomber/p/dev/react/node_modules/memoize-one/esm/index.js
...
// EXTERNAL MODULE: /home/pomber/p/dev/react/node_modules/object-assign/index.js
...
var src_bridge = __webpack_require__(18);
...
class agent_Agent extends events["a" /* default */] {
  constructor(bridge) {
    ...
    _defineProperty(this, "logElementToConsole", ({
      ...
      // console.log(`Logging from AGENT`);
      const renderer = this._rendererInterfaces[rendererID];
...
const Yallist = __webpack_require__(28);
...
function setup(hook) {
  ...
  const Bridge = __webpack_require__(18).default;

  const {
    initBackend
  } = __webpack_require__(36);

  const setupNativeStyleEditor = __webpack_require__(37).default;
...
try {
  ...
  __webpack_require__(29)(Yallist);
} catch (er) {}
...
var h = __webpack_require__(7),
    ...
    q = __webpack_require__(34).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    w = [],
    x = null;
